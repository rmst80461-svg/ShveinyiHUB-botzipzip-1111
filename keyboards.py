...
def get_main_menu() -> InlineKeyboardMarkup:
    ...
    # Если зашел админ, добавляем кнопку возврата в админку
    # Но так как здесь нет доступа к user_id, это делается в хендлере.
    # Для простоты добавим кнопку в общее меню, если это уместно.
