            ...
            try:
                ...
                client_messages = {
                    ...
                    (f"{client_name}, отличные новости! 🎉\n"
                     ...
                     f"Я, Иголочка, лично за ним присматриваю 🧵\n"
                     f"Как только всё будет идеально — вам тут же сообщу!"),
                    "completed":
                    (f"{client_name}, ваш заказ готов! 🎉✂️\n"
                     f"Заказ {formatted_id} ждёт вас!\n\n"
                     f"📍 {WORKSHOP_ADDRESS}\n"
                     f"🕐 Пн-Чт: 10:00-19:50\n"
                     f"🕐 Пт: 10:00-19:00\n"
                     f"🕐 Сб: 10:00-17:00\n"
                     f"📞 {WORKSHOP_PHONE}\n\n"
                     f"Жду вас! Ваша Иголочка 🪡")
                }
